...
    console.log("Cargando y descomprimiendo productos desde:", `/price-lists-json/${currentJsonFileName}`); // Modificado path aquí
    loader.classList.remove("hidden");
    try {
      const response = await fetch(`/price-lists-json/${currentJsonFileName}`); // Modificado path aquí
      if (!response.ok) {
